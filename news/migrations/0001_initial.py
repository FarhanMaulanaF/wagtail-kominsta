    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_news_relationship', to='people.person')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
